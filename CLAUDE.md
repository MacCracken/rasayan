# Rasayan — Claude Code Instructions

## Project Identity

**Rasayan** (Sanskrit: रसायन — alchemy, chemistry of life) — Biochemistry engine: enzyme kinetics, metabolic pathways, signal transduction, protein structure, membrane transport, bioenergetics
...
mastishk (neuroscience), sharira (physiology), jivanu (microbiology), kimiya (general chemistry), kiran (game engine — biological simulation)
